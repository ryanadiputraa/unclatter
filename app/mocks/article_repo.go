...
// Delete provides a mock function with given fields: ctx, userID, articleID
func (_m *ArticleRepository) Delete(ctx context.Context, userID string, articleID string) error {
